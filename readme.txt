...
= Notes =
1. The plugin needs Contact Form 7 to be activated.
...
= Do I have to have contact form 7 plugin? =

Yes, this plugin is the extension to the famous Contact Form 7 plugin and you know CF7 is needed.

== Upgrade Notice ==

== Screenshots ==
1. How it looks in the backend:
